...
USERS_TABLE_FIELDS = ('chat_id', 'lang', 'main_message_id',
                      'block_info_message_id', 'floor_info_message_id',)
    ...
    with sqlite3.connect(DATABASE) as conn:
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS users (
                ...
                block_info_message_id INTEGER,
                floor_info_message_id INTEGER
            )
        ''')
...
class User:
    ...
    def current_message_id(self) -> Any:
        """Edit field by field name."""
        main_message_id = self.get_field('main_message_id')
